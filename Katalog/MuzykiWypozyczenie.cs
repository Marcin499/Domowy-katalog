    ...
    public partial class MuzykiWypozyczenie : Form
    {
        ...
        public MuzykiWypozyczenie()
        {
           ...
           InitializeComponent();
            ...
            cmd.CommandText = "Select * from  BazaMuzykiWypozyczenie Where Data_zwrotu = '" + label8.Text + "'";
            cmd.ExecuteNonQuery();
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "Insert into  BazaMuzykiWypozyczenie (ID,Imię, Nazwisko, Tytuł, Data_wypożyczenia, Data_zwrotu) values (@ID,@Imię, @Nazwisko, @Tytuł, @Data_wypożyczenia, @Data_zwrotu)";
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Delete from BazaMuzykiWypozyczenie Where ID = '" + textBox1.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
                textBox1.Clear();
                textBox2.Clear();
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "Select * from  BazaMuzykiWypozyczenie";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter sa = new SqlDataAdapter(cmd);
            sa.Fill(dt);
