...
namespace Katalog
{
    public partial class KsiazkiWypozyczenie : Form
    {
        ...
        public KsiazkiWypozyczenie()
        {
            ...
            cmd.CommandText = "Select * from  BazaKsiazkiWypozyczenie Where Data_zwrotu = '" + label8.Text + "'";
            cmd.ExecuteNonQuery();
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "Select * from  BazaKsiazkiWypozyczenie";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter sa = new SqlDataAdapter(cmd);
            sa.Fill(dt);
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "Insert into  BazaKsiazkiWypozyczenie (ID,Imię, Nazwisko, Tytuł, Data_wypożyczenia, Data_zwrotu) values (@ID,@Imię, @Nazwisko, @Tytuł, @Data_wypożyczenia, @Data_zwrotu)";
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Delete from BazaKsiazkiWypozyczenie Where ID = '" + textBox1.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
                textBox1.Clear();
                textBox2.Clear();
        ...
        private void KsiazkiWypozyczenie_Load(object sender, EventArgs e)
        {
